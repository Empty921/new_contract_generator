...
Откройте в браузере http://127.0.0.1:5173. Зарегистрируйте нового пользователя. После загрузки откройте «Настройка переменных», настройте типы и подписи, нажмите «Опубликовать». Перейдите в «Создание», заполните поля и нажмите «Сгенерировать документ». Файл скачается — откройте и проверьте.
